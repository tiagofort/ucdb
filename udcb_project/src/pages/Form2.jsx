...
const questions = [
  ...
  '2- Consigo compreender como uma pessoa pode chegar ao ponto de tentar suicídio.',
  '3- Eu me sinto confortável em conversar sobre suicídio.',
  ...
  '7- Sinto-me capaz de perceber quando um paciente tem risco de se matar.',
  ...
  '18- Quando uma pessoa fala em pôr fim à vida, tento tirar aquilo da cabeça dela.',
        ...
        <div>
            {questions.map((q, index) => (
                <QuestionSlider
                    ...
                    onFinalChange={() => handleFinalAnswer(index)}
                />
            ))}
        </div>
    </form>
